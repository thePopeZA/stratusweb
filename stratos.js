...
(function () {
  ...
  var HTML = ''
    ...
    + '<div id="st-body"></div>'
    + '<div id="st-chips">'
    + '<button data-q="I want hosting and a domain — what are my options?">Hosting &amp; a domain</button>'
    + '<button data-q="I need a website for my business">A website</button>'
    + '<button data-q="I have a bespoke software project in mind — can Stratus build it?">Bespoke software</button>'
    + '<button data-q="How does an AI front desk work and what does it cost?">AI front desk</button>'
    + '</div>'
